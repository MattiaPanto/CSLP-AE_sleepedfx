...
if __name__ == '__main__':
    ...
    for para_num, para in enumerate(tqdm(['ERN', 'LRP', 'MMN', 'N2pc', 'N170', 'N400', 'P3'])):
        ...
        cur_dir = f'D:/dataset/ERP CORE/{para} All Data and Scripts/'
        ...
        for subj in tqdm(range(1,41)):
            ...
            '''
            {t<finestra-temporale> pre-eventi}.{locking events}{eventi successivi}
            '''
            if not full:
                if para == 'ERN':
            ...
            #raw.get_data -> (num epochs, num channel, sample)
