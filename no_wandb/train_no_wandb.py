...
from extra.utils_originale import get_results, get_eval_results, get_split_latents, CustomLoader, fit_knn_fn, fit_etc_fn
        ...
        for i in pbar:
            ...
            if i % args.eval_every == 0:
                with torch.no_grad():
                    ...
                    data['eval_results'].append(eval_results)
                    if not OLD_SCHED:
